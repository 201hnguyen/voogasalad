...
public class StatusBar extends HBox {
    ...
    private Map<String, Integer> myGameInfoMap;

    public void StatusBar(Map<String, Integer> gameInfoMap) {
        myGameInfoMap = gameInfoMap;
    ...
    private ImageView iconLoader(String iconIdentifier) {
        ...
        ImageView icon = new ImageView(new Image(iconIdentifier));
